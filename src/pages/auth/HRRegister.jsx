...
import { Mail, User, Phone, Lock, Briefcase, MapPin, Calendar, X } from 'lucide-react';
...
const HRRegister = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Redirect to manage-hr after successful registration
    navigate('/manage-hr');
  };
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-4xl">
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-2xl font-bold text-gray-900">Register New HR</h2>
            <button
              onClick={() => navigate(-1)}
              ...
              <div>
                ...
                <div className="mt-1 relative rounded-md shadow-sm">
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className="focus:ring-indigo-500 focus:border-indigo-500 block w-full pl-10 sm:text-sm border-gray-300 rounded-md py-3 border bg-white"
                  >
