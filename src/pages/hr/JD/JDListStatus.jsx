...
const JobListingsDashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-white text-[#4f46e5] flex">
      {/* Sidebar: static on left, full height on md+ */}
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex">
        <SideNavBar collapsed={collapsed} setCollapsed={setCollapsed} />
      </div>
      {/* Main content area: header, content, footer */}
      <div className>
        {/* Header at top, inside main content */}
        <div className="flex-1 flex flex-col">
          <Header />
        </div>
        {/* Main content: fills remaining space */}
        <div className="flex-1 p-2 sm:p-4">
          {/* ...existing code for job cards and pagination... */}
