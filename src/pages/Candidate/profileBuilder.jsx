...
const CandidateProfile = () => {
  ...
  // Typing animation effect only when not in edit mode
  useEffect(() => {
    if (!isEditMode) {
      ...
      setTypedName(currentData.name); // Ensure full name is shown in edit mode
    }
  }, [currentData.name, isEditMode]);
        ...
        <div className="bg-white/80 backdrop-blur-xl border border-gray-200 rounded-3xl overflow-hidden shadow-2xl">
          <div className="relative bg-gradient-to-r from-indigo-500 to-purple-600 px-10 py-16 text-center overflow-hidden">
            <div className="relative inline-block mb-8">
              ...
              <div 
                ...
                style={{ boxShadow: '0 0 0 10px rgba(79, 70, 229, 0.2)' }}
          ...
          <div className="p-10 lg:p-16">
            <div 
              ...
              className={`mb-16 transform transition-all duration-700 ${isVisible['resume-upload'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
            >
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-2xl p-8 backdrop-blur-sm transition-all duration-300 hover:bg-gray-100 hover:shadow-xl">
                {uploadedResume ? (
                  ...
                  <div 
                    className={`border-2 border-dashed border-gray-300 rounded-xl p-8 text-center transition-all duration-300 ${isEditMode ? 'hover:border-indigo-400 cursor-pointer' : ''}`}
            ...
            <div 
              ...
              className={`mb-16 transform transition-all duration-700 ${isVisible['personal-info'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
            >
            ...
            <div 
              ref={registerElement}
              data-id="skills"
              className={`mb-16 transform transition-all duration-700 ${isVisible['skills'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
            >
              <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-xl flex items-center justify-center text-white">
            ...
            <div 
              ref={registerElement}
              data-id="experience"
              className={`mb-16 transform transition-all duration-700 ${isVisible['experience'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
            >
              <div className="flex items-center justify-between mb-8">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-gradient-to-r from-indigo-500 to-purple-500 rounded-xl flex items-center justify-center text-white">
